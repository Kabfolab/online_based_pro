...
<body>
    ...
    <script>
        $(document).ready(function() {
            $('.sub-links').hide(); // Initially hide all sub-links
            ...
            $('.main-link').click(function(e) {
                ...
                if ($subLinks.is(':visible')) {
                    $subLinks.slideUp();
                    $this.find('.arrow').html('&#8250;'); // Change arrow to right
                } else {
                    $('.sub-links').slideUp(); // Hide all sub-links
                    $('.main-link .arrow').html('&#8250;'); // Reset all arrows
                    $subLinks.slideDown();
                    $this.find('.arrow').html('&#9660;'); // Change arrow to down
                }
